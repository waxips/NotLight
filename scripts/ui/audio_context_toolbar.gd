...
class_name AudioContextToolbar
...
func configure(display_name: String, available: bool) -> void:
	if _name_label == null:
		return
	_name_label.text = display_name if not display_name.is_empty() else NotLightL10n.text("board.asset.audio")
	_name_label.tooltip_text = _name_label.text if available else NotLightL10n.text("audio.error.source_unavailable")
...
func _build_ui() -> void:
	...
	type_label.text = "♪"
	NotLightL10n.bind_tooltip(type_label, "board.asset.audio")
	...
	NotLightL10n.bind_text(_name_label, "board.asset.audio")
	...
	NotLightL10n.bind_text(_play_button, "audio.toolbar.play")
	NotLightL10n.bind_tooltip(_play_button, "audio.toolbar.play_help")
	_play_button.theme_type_variation = "GhostButton"
	_play_button.custom_minimum_size = Vector2(118.0, 36.0)
	...
	NotLightL10n.bind_tooltip(duplicate_button, "audio.toolbar.duplicate_help")
